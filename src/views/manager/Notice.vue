<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入标题查询" style="width: 250px" v-model="title"></el-input>
      <el-input placeholder="请输入内容查询" style="width: 250px; margin-left: 10px" v-model="content"></el-input>
