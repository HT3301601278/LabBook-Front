<template>
  <div>
    <div class="search">
      ...
      <el-input placeholder="请输入内容查询" style="width: 200px; margin-left: 10px" v-model="content"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="creatorName" label="创建人" min-width="10%"></el-table-column>
    ...
    <el-dialog :title="form.id ? '编辑公告信息' : '新增公告信息'" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" :append-to-body="true" destroy-on-close center>
